...
function randomNumQuestion() {
    ...
    for (var guess = 4; guess >= 1; guess--) {
        var answer7 = prompt('Can you guess a random number between 1 and 10? You have ' + (guess) + ' more tries.');
...
function guessSnacks() {
    ...
    for (var guess = 6; guess >= 1; guess--) {
        var answer8 = prompt('Guess one of my favorite junk foods or candy! You have ' + (guess) + ' more tries.').toLowerCase();
